...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (token != null) {
      ...
      setState(() {
        userName = "${claims['name'] ?? ''} ${claims['last_name'] ?? ''}".trim();
  ...
  Widget _buildInfoRow(IconData icon, String title, String value) {
    return ListTile(
      ...
      subtitle: Text(value, style: const TextStyle(fontSize: 15, color: Color(0xFF333333), fontWeight: FontWeight.w500)),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: const Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Icon(Icons.person, size: 55, color: Color(0xFF667EEA)),
                  ),
                ),
              ),
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      _buildInfoRow(Icons.email_outlined, "Correo Electrónico", userEmail),
                      const Divider(height: 1, color: Color(0xFFEEEEEE)),
                      _buildInfoRow(Icons.phone_outlined, "Teléfono Celular", userPhone),
                      const Divider(height: 1, color: Color(0xFFEEEEEE)),
                      _buildInfoRow(Icons.location_on_outlined, "Dirección de Domicilio", userAddress),
                      const Divider(height: 1, color: Color(0xFFEEEEEE)),
                      _buildInfoRow(Icons.maps_home_work_outlined, "Barrio Asignado", userNeighborhood),
                    ],
                  ),
                ),
              ),
